...
<div class="row g-4">
    <div class="col-lg-8">
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <h5 class="card-title">What is ASPpy?</h5>
                <p>
                    ASPpy is a Python-based runtime that executes Classic ASP (VBScript) pages.
                ...
                <p>
                    ...
                    using ASPpy, with proper separation of concerns, database operations, and 
        ...
        <div class="card shadow-sm mt-3">
            <div class="card-body small">
                <p class="mb-2">
                    ...
                    <strong>Framework:</strong> ASPpy<br>
