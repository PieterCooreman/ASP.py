...
Sub ActionIndex()
    ...
    Response.Write "    <title>" & appName & " - ASP4 MVC</title>" & vbCrLf
    ...
    Response.Write "                <h1 class='display-5 fw-bold'>Welcome to ASP4 MVC</h1>" & vbCrLf
    Response.Write "                <p class='lead'>This is a sample MVC application built with ASP4.</p>" & vbCrLf
...
Sub ActionAbout()
    ...
    Response.Write "                        <div class='card-body'>" & vbCrLf
    Response.Write "                            <h5 class='card-title'>What is ASP4?</h5>" & vbCrLf
    Response.Write "                            <p>ASP4 is a Python-based runtime that executes Classic ASP (VBScript) pages. It provides compatibility with VBScript built-in functions and the Classic ASP object model.</p>" & vbCrLf
    Response.Write "                        </div>" & vbCrLf
    Response.Write "                    </div>" & vbCrLf
...
Sub RenderNav()
    ...
    Response.Write "        <div class='container'>" & vbCrLf
    Response.Write "            <a class='navbar-brand' href='index.asp'><i class='bi bi-gear-fill me-2'></i>ASP4 MVC</a>" & vbCrLf
...
Sub RenderFooter()
    ...
    Response.Write "            <p class='mb-1'><i class='bi bi-gear-fill me-1'></i>ASP4 MVC Sample v" & Application("AppVersion") & "</p>" & vbCrLf
    Response.Write "            <small>Built with ASP4 - Classic ASP/VBScript → Python Transpiler</small>" & vbCrLf
    Response.Write "        </div>" & vbCrLf
