...
Sub ActionList()
    ...
    Response.Write "    <title>Products - ASP4 MVC</title>" & vbCrLf
    ...
    Response.Write "            <p class='mb-1'><i class='bi bi-gear-fill me-1'></i>ASP4 MVC Sample</p>" & vbCrLf
    Response.Write "            <small>Built with ASP4</small>" & vbCrLf
    Response.Write "        </div>" & vbCrLf
...
Sub ActionView()
    ...
    If itemObj Is Nothing Then
        ...
        Response.Write "    <meta charset='utf-8'>" & vbCrLf
        Response.Write "    <meta name='viewport' content='width=device-width, initial-scale=1'>" & vbCrLf
        Response.Write "    <title>Product Not Found - ASP4 MVC</title>" & vbCrLf
        Response.Write "    <link href='https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css' rel='stylesheet'>" & vbCrLf
        Response.Write "    <link href='https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.0/font/bootstrap-icons.min.css' rel='stylesheet'>" & vbCrLf
        Response.Write "    <style>body { display: flex; flex-direction: column; min-height: 100vh; } main { flex: 1; }</style>" & vbCrLf
        Response.Write "</head>" & vbCrLf
    ...
    Response.Write "    <meta charset='utf-8'>" & vbCrLf
    Response.Write "    <meta name='viewport' content='width=device-width, initial-scale=1'>" & vbCrLf
    Response.Write "    <title>" & HtmlEncode(itemObj.Name) & " - ASP4 MVC</title>" & vbCrLf
    Response.Write "    <link href='https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css' rel='stylesheet'>" & vbCrLf
    Response.Write "    <link href='https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.0/font/bootstrap-icons.min.css' rel='stylesheet'>" & vbCrLf
    Response.Write "    <style>body { display: flex; flex-direction: column; min-height: 100vh; } main { flex: 1; }</style>" & vbCrLf
    Response.Write "</head>" & vbCrLf
...
Sub ActionCreate()
    ...
    Response.Write "    <meta charset='utf-8'>" & vbCrLf
    Response.Write "    <meta name='viewport' content='width=device-width, initial-scale=1'>" & vbCrLf
    Response.Write "    <title>Create Product - ASP4 MVC</title>" & vbCrLf
    Response.Write "    <link href='https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css' rel='stylesheet'>" & vbCrLf
    Response.Write "    <link href='https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.0/font/bootstrap-icons.min.css' rel='stylesheet'>" & vbCrLf
    Response.Write "    <style>body { display: flex; flex-direction: column; min-height: 100vh; } main { flex: 1; }</style>" & vbCrLf
    Response.Write "</head>" & vbCrLf
...
Sub ActionEdit()
    ...
    Response.Write "    <meta charset='utf-8'>" & vbCrLf
    Response.Write "    <meta name='viewport' content='width=device-width, initial-scale=1'>" & vbCrLf
    Response.Write "    <title>Edit " & HtmlEncode(itemObj.Name) & " - ASP4 MVC</title>" & vbCrLf
    Response.Write "    <link href='https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css' rel='stylesheet'>" & vbCrLf
    Response.Write "    <link href='https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.0/font/bootstrap-icons.min.css' rel='stylesheet'>" & vbCrLf
    Response.Write "    <style>body { display: flex; flex-direction: column; min-height: 100vh; } main { flex: 1; }</style>" & vbCrLf
    Response.Write "</head>" & vbCrLf
...
Sub ActionDelete()
    ...
    Response.Write "    <meta charset='utf-8'>" & vbCrLf
    Response.Write "    <meta name='viewport' content='width=device-width, initial-scale=1'>" & vbCrLf
    Response.Write "    <title>Delete " & HtmlEncode(itemObj.Name) & " - ASP4 MVC</title>" & vbCrLf
    Response.Write "    <link href='https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css' rel='stylesheet'>" & vbCrLf
    Response.Write "    <link href='https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.0/font/bootstrap-icons.min.css' rel='stylesheet'>" & vbCrLf
    Response.Write "    <style>body { display: flex; flex-direction: column; min-height: 100vh; } main { flex: 1; }</style>" & vbCrLf
    Response.Write "</head>" & vbCrLf
